...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@people': path.resolve(__dirname, './src/assets/img/people'),
      '@providers': path.resolve(__dirname, './src/assets/img/providers'),
      '@backgrounds': path.resolve(__dirname, './src/assets/img/backgrounds'),
      '@misc': path.resolve(__dirname, './src/assets/img/misc'),
    },
  },
});